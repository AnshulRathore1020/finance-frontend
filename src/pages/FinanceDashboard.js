...
function Dashboard() {
  ...
  const fetchSummary = async () => {
    try {
      const res = await axios.get(
        'http://localhost:8080/api/dashboard/summary', { headers });
      setSummary(res.data);
    } catch (err) {
      console.error(err);
    }
  ...
  const fetchCategoryWise = async () => {
    try {
      const res = await axios.get(
        'http://localhost:8080/api/dashboard/category-wise', { headers });
  ...
  const fetchRecentActivity = async () => {
    try {
      const res = await axios.get(
        'http://localhost:8080/api/dashboard/recent-activity', { headers });
